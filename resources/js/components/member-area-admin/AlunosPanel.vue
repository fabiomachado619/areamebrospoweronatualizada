...
const props = defineProps({
    ...
    showProdutosTabs: { type: Boolean, default: false },
    listPath: { type: String, default: '/produtos/alunos' },
    fixedQuery: { type: Object, default: () => ({}) },
    productFilterLabel: { type: String, default: 'Produtos' },
    statsProductsLabel: { type: String, default: 'Produtos com alunos' },
    tableProductsLabel: { type: String, default: 'Produtos' },
...
function applyQuery(overrides = {}) {
    router.get(props.listPath, { ...props.fixedQuery, ...buildQuery(overrides) }, { preserveState: true, preserveScroll: true, replace: true });
}
...
<template>
    <div class="space-y-6">
        <ProdutosTabs v-if="showProdutosTabs" />
        ...
        <div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            ...
            >
                <div class="flex items-center gap-2 text-zinc-600 dark:text-zinc-400">
                    ...
                    <span class="text-sm font-medium">{{ statsProductsLabel }}</span>
                </div>
                <p class="mt-2 text-2xl font-bold text-zinc-900 dark:text-white">
        ...
        <AlunoDetailSidebar
            ...
            :enable-resend-access-email="enableResendAccessEmail"
        />
